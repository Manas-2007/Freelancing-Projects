...
const StatusNavbar = ({ setIsOpen }) => {
  const userName = "Manas"; // Based on your profile
  ...
  return (
   <header className="w-full bg-[#f8f9fa]/90 backdrop-blur-md px-[10px] sm:px-[20px] md:px-[30px] py-[12px] md:py-[18px] shadow-md border-b border-gray-200 flex items-center justify-between sticky top-0 z-20">
      ...
      <div className="flex items-center gap-2 sm:gap-4 md:gap-6 flex-shrink-0">
        ...
        {/* PROFILE LINK (Updated to open Profile page) */}
        <Link to="/profile">
          <button className="w-[42px] h-[42px] bg-white/70 backdrop-blur-md border border-red-400 rounded-[14px] flex items-center justify-center shadow-sm hover:shadow-md transition-all active:scale-95 group">
