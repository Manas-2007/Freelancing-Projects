...
{/* ================= LOGO SECTION ================= */}
      <div className="mb-[0px] relative group px-2"> 
        ...
        <div className="relative p-1.5"> 
          ...
          <div className="hidden md:block">
            ...
            <div className="flex flex-col gap-3">
              <p className="text-[10px] font-bold text-gray-500/80 uppercase tracking-[1.5px] italic">
                Donate Blood • Save Lives
              </p>
              
              {/* Premium Badge with Glass effect */}
              <div className="inline-flex items-center self-start bg-gradient-to-r from-red-50 to-amber-50 px-3 py-1.5 rounded-full border border-red-400 shadow-inner">
          ...
          <div className="md:hidden flex flex-col items-center text-center">
            <button 
              ...
              className="absolute right-0 top-0 text-gray-400 hover:text-red-700 transition-colors p-2"
            >
              <IoClose size={24} />
            </button>
            
            <img src="/navlogo.jpg" className="w-[50px] h-[50px] object-contain mb-2 drop-shadow-md" alt="logo" />
        ...
        {/* Premium Divider - Styled to look like a light refraction */}
      ...
      <nav className="flex-1 flex flex-col gap-1 overflow-y-auto no-scrollbar pr-1">
        {menuItems.map((item) => (
          <NavLink
            ...
            className={({ isActive }) => `
              ...
              px-4 py-2 rounded-xl  /* Reduced py-3 to py-2 */
              transition-colors duration-200
              ${isActive ? 'bg-[#880808] text-white' : 'text-black hover:text-[#880808] hover:bg-white/60 '}
        ...
        {/* FIXED LOGOUT BUTTON: mt-auto ensures it sits right above the helpline */}
        <button 
          onClick={onLogout}
      ...
      <div className="mt-4 bg-[#880808] p-3 rounded-2xl text-center shadow-md shrink-0">
        <p className="text-white/80 text-[9px] font-bold uppercase mb-0.5">
          Emergency Helpline
        </p>
