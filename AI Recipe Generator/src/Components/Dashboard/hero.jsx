export function RecipeCard() {
  return (
    <div
      className="w-full md:w-[390px] p-[2.5px] rounded-2xl"
      style={{
        background: "linear-gradient(90deg, #ff0080, #7b2ff7, #40e0d0, #ff8c00, #ff0080)",
        backgroundSize: "200% 100%",
        animation: "borderGlow 3s linear infinite",
        boxShadow: "0 0 20px rgba(123,47,247,0.3), 0 0 40px rgba(255,0,128,0.12), 0 4px_24px rgba(0,0,0,0.5)",
      }}
    >
      <div className="w-full
        bg-gradient-to-br from-[#1a1630]/95 via-[#150f2a]/95 to-[#0f0c1e]/95
        backdrop-blur-2xl rounded-[14px] overflow-hidden group
        hover:from-[#1e1a38]/95 hover:via-[#190f30]/95
